...
const DIFFICULTY_GUIDANCE: Record<Language, Record<DifficultyLevel, string>> = {
  en: {
    elementary:
      'Use very simple language appropriate for grades K-5. Use concrete examples like counting objects or simple shapes.',
    'middle-school':
      'Use clear language appropriate for grades 6-8. Balance formal math terms with accessibility.',
    'high-school':
      'Use standard mathematical terminology appropriate for grades 9-12. Assume familiarity with algebra and geometry.',
    college:
      'Use precise mathematical language appropriate for university level. Reference theorems and formal definitions.',
  },
  es: {
    elementary:
      'Use un lenguaje muy simple apropiado para los grados K-5. Use ejemplos concretos como contar objetos o formas simples.',
    'middle-school':
      'Use un lenguaje claro apropiado para los grados 6-8. Equilibre los términos matemáticos formales con la accesibilidad.',
    'high-school':
      'Use terminología matemática estándar apropiada para los grados 9-12. Asuma familiaridad con álgebra y geometría.',
    college:
      'Use un lenguaje matemático preciso apropiado para el nivel universitario. Referencie teoremas y definiciones formales.',
  },
  fr: {
    elementary:
      'Utilisez un langage très simple approprié pour les classes K-5. Utilisez des exemples concrets comme compter des objets ou des formes simples.',
    'middle-school':
      "Utilisez un langage clair approprié pour les classes 6-8. Équilibrez les termes mathématiques formels avec l'accessibilité.",
    'high-school':
      "Utilisez une terminologie mathématique standard appropriée pour les classes 9-12. Présumez une familiarité avec l'algèbre et la géométrie.",
    college:
      'Utilisez un langage mathématique précis approprié pour le niveau universitaire. Référencez des théorèmes et des définitions formelles.',
  },
  de: {
    elementary:
      'Verwenden Sie sehr einfache Sprache, die für die Klassen K-5 geeignet ist. Verwenden Sie konkrete Beispiele wie das Zählen von Objekten oder einfachen Formen.',
    'middle-school':
      'Verwenden Sie klare Sprache, die für die Klassen 6-8 geeignet ist. Balancieren Sie formale mathematische Begriffe mit Zugänglichkeit.',
    'high-school':
      'Verwenden Sie standardmäßige mathematische Terminologie, die für die Klassen 9-12 geeignet ist. Gehen Sie von Vertrautheit mit Algebra und Geometrie aus.',
    college:
      'Verwenden Sie präzise mathematische Sprache, die für das Universitätsniveau geeignet ist. Verweisen Sie auf Theoreme und formale Definitionen.',
  },
  zh: {
  ...
  ja: {
    elementary:
      '幼稚園から5年生に適した非常に簡単な言葉を使用してください。物を数えたり、簡単な形などの具体的な例を使用してください。',
    'middle-school':
      '6-8年生に適した明確な言葉を使用してください。正式な数学用語と理解しやすさのバランスをとってください。',
    'high-school':
      '9-12年生に適した標準的な数学用語を使用してください。代数と幾何学に精通していると仮定してください。',
    college:
      '大学レベルに適した正確な数学的言語を使用してください。定理と正式な定義を参照してください。',
  },
};
 ...
 */
const INSTRUCTION_HEADERS: Record<
  Language,
  {
    hintLevel: string;
    difficulty: string;
